     ...
     <div class="box box-primary filter_box" style="display: none;">
        ...
        <div class="box-body">
          <div class="row">
				<div class="col-md-6">
	              ...
	              {{Form::select('city_id',$city_select_list, '', ['class' => 'form-control select2 filter_city_id filter-select','style'=>'width: 100%','placeholder'=>'Please Select'])}}
	              </div>
      ...
      <div class="col-xs-12">
        ...
        <div class="box-tools pull-right">
           <a href="{{ route('area.create') }}" class="btn btn-primary">Add <i class="fa fa-plus"></i></a>
           ...
           <button type="button" class="btn btn-primary">Export <i class="fa fa-fw fa-cloud-download"></i></button>
                  ...
                  <ul class="dropdown-menu btn-default" role="menu">
                    <li><a href="{{route('area.export_excel')}}">Export To Excel <i class="fa fa-fw fa-file-excel-o"></i></a></li>
                    <li><a href="{{route('area.export_csv')}}">Export To CSV <i class="fa fa-fw fa-file-excel-o"></i></a></li>
                  </ul>
                </div>
            ...
            <div class="box-body">
              ...
              <table id="Area" class="table table-bordered  table-striped" style="width: 100%;">
                 ...
                 <tr>
                  ...
                  <th>ID</th><th>City</th><th>Name</th><th>Sort Order</th>
                  <th>Status</th>
                  <th>Action</th>
                </tr>
                 </thead>
  ...
  //================= DATA TABLE START =================//
   table = table_id.DataTable({
        ajax :{
            ...
            data: function (yns) {yns.city_id = $('.filter_city_id').val(),yns.name = $('.filter_name').val(),yns.sort_order = $('.filter_sort_order').val(),yns.status = $('.filter_status').val()
            },
            dataType: 'json',
            type: 'GET',
          },
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Import Area</h4>
          </div>
         
         {!! Form::open(['method'=>'POST','route'=>['area.import'],'role'=>'form','files'=>true,'class'=>'import_form']) !!} 
          <div class="modal-body">
            <table class="table image-table">
                ...
                <td  style="vertical-align: middle;text-align: left;"> 
               <a style="width: 100%;height: 100%;"  href="{{ asset('public/import_sample_sheets/area.xlsx') }}" class="btn btn-primary pull-left">Download Sample</a>
                 </td>
