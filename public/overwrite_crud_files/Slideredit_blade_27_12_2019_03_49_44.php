...
<section class="content">
  @include('flash_messages.admin_message')
    <!-- SELECT2 EXAMPLE -->
    {!! Form::open(['method'=>'PUT','route'=>['slider.update',$result->id],'role'=>'form','class'=>'form-data','files'=>true]) !!} 
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('subtitle',$result->subtitle,['class'=>'form-control','placeholder'=>'Subtitle'])!!}
                ...
                <div class="form-group">
                  <label>Link  </label>
                  {!! Form::textarea('link',$result->link,['class'=>'form-control','rows'=>'3','placeholder'=>'Link'])!!}
       ...
       <div class="box-footer">
                ...
                <a href="{{ route('slider.index') }}" class="btn btn-default">Back</a>
        </div>
