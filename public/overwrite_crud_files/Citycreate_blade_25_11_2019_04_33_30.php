...
<section class="content">
  @include('flash_messages.admin_message')
    <!-- SELECT2 EXAMPLE -->
    {!! Form::open(['method'=>'POST','route'=>['city.store'],'files'=>true,'role'=>'form','class'=>'form-data']) !!} 
        ...
        <div class="box-body">
          <div class="row">
				<div class="col-md-6">
	              ...
	              {{Form::select('state_id',$state_select_list, '', ['class' => 'form-control select2','style'=>'width: 100%','placeholder'=>'Please Select'])}}
