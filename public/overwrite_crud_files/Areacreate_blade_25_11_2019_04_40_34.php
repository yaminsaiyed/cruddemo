...
<section class="content">
  @include('flash_messages.admin_message')
    <!-- SELECT2 EXAMPLE -->
    {!! Form::open(['method'=>'POST','route'=>['area.store'],'files'=>true,'role'=>'form','class'=>'form-data']) !!} 
        ...
        <div class="box-body">
          <div class="row">
				<div class="col-md-6">
	              ...
	              {{Form::select('city_id',$city_select_list, '', ['class' => 'form-control select2','style'=>'width: 100%','placeholder'=>'Please Select'])}}
