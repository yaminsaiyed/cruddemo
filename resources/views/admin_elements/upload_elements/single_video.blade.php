...
$(document).on('change','body .inputFileUpload_video',function(){
...
// formData.append("input_file_key", input_file_key);
  ...
  $.ajax({
    ...
    url: "{{ route('admin.upload_single_video') }}",
    ...
    success: function(data){
       ...
       if (data.status==true) {
        ...
        this_obj.parent().parent().parent().find(".video_anchor_tag").attr("href", data.video_anchor_tag);

        this_obj.parent().parent().parent().find(".hidden_filename").val(data.filename);

        this_obj.parent().parent().parent().find(".file_error").text("");

        this_obj.parent().parent().parent().find(".remove_video").show();
        ...
        this_obj.parent().parent().parent().find(".remove_video").hide();

        this_obj.parent().parent().parent().find(".inputFileUpload_video").val("");
...
$(document).on('click','body .remove_video',function(){
  ...
  $.ajax({
    ...
    url: "{{ route('admin.remove_single_video') }}",
    ...
    success: function(data){
       ...
       if (data.status==true) {
        ...
        this_obj.parent().parent().find(".video_anchor_tag").attr("href", data.video_anchor_tag);

        this_obj.parent().parent().find(".hidden_filename").val("");

        this_obj.parent().parent().find(".remove_video").hide();

        this_obj.parent().parent().find(".inputFileUpload_video").val("");
